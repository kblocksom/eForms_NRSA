...
verification_tbl$PARAMETER[verification_tbl$PARAMETER=='LON_ID'] <- 'Longitude'
...
verification_tbl$RESULT[verification_tbl$PARAMETER=='Reach Length'] <- paste(verification_tbl$RESULT, 'm', sep=' ') 
...
kable(samples_tbl, col.names=c('Sample Name', 'Description'), align=c('l','r')) %>%
